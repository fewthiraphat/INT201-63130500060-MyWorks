...
//1
let product1ShowDiv = document.createElement("div");
product1ShowDiv.setAttribute("id" , product.id)

let product1Img = document.createElement("img");
product1Img.setAttribute("src","https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/iphone-13-pro-family-hero?wid=940&hei=1112&fmt=png-alpha&.v=1631220221000")
product1Img.setAttribute("style","width:200px;heght:200px;")
product1ShowDiv.append(product1Img);

let product1Name = document.createElement("p");
product1Name.textContent = product.name;
product1ShowDiv.append(product1Name);

let product1Desc = document.createElement("p");
product1Desc.textContent = product.desc;
product1ShowDiv.append(product1Desc);

let product1Price = document.createElement("p");
product1Price.textContent = product.price;
product1ShowDiv.append(product1Price);
productDiv.append(product1ShowDiv)
